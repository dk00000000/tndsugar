<?  
     // session_start();
      ...
      if(isset($_POST['getFornight'])){
         ...
         $fornightres = $curd->GetSelData($oldFilter,$newFilter,'asto_canebill_print.ini','FORNIGHT');
     ...
     <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
           <form id="districtform" class="form-horizontal form-label-left" method="POST" action="asto_canebill_print.php" target="_blank" >
 ...
 $(document).ready(function() {
    ...
    $('#season').change(function(){
        ...
        jQuery.ajax({ 
            ...
            datatype: "json",
            async: false,
            url: "asto_canebillprint_input.php",
