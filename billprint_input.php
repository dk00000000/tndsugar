     ...
     <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
           <form id="districtform" class="form-horizontal form-label-left" method="POST" action="../../../../../billprint.php" target="_blank" >
          
           <span class="section">Bill Print: Report Input</span>
