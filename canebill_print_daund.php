...
.particulars-slip-no { position: absolute;
      overflow: visible;
      top:58mm;
      left:100mm;
      height: 10mm;
...
<td halign="bottom" align="left" style="height:130px; width=30%">'.$printdataRes[0]['SEASON'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$srno.'</td>
</tr>
</table>
</div>
...
<td align="left" height="10mm" valign="top" style="width:78%" colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$printdataRes[0]['FARMER']." ".$printdataRes[0]['PRT_MNAME'].'</td>
</tr>

<tr>
<td style="width:7%">&nbsp;</td>
<td align="left" style="width:43%;" colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$printdataRes[0]['SR_MNAME'].'</td>
<td align="center" style="width:50%;" colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$printdataRes[0]['SC_MNAME'].'</td>
</tr>
</table>
</div>
...
<td align="center
">'.$printdataRes[0]['TXD_AMT'].'</td>
</tr>
</table>
</div> 

<div class="particulars-slip-no">
<table width="100%">
<tr>
<td align="right"></td>
<td align="right">स्लिप संख्या.</td>
<td align="left">'.$printdataRes[0]['SLIPS'].'</td>
</tr>
</table>
</div>
...
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[0]['SR']." ".$detailRes[0]['DED_NAME'].'</td>
<td align="center" valign="top" style="width:30%;">'.$detailRes[0]['TXD_AMT'].'</td>
</tr>
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[2]['SR']." ".$detailRes[2]['DED_NAME'].'</td>
<td align="center" valign="top" style="width:30%;">'.$detailRes[2]['TXD_AMT'].'</td>
</tr>
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[4]['SR']." ".$detailRes[4]['DED_NAME'].'</td>
<td align="center" valign="top" style="width:30%;">'.$detailRes[4]['TXD_AMT'].'</td>
</tr>
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[6]['SR']." ".$detailRes[6]['DED_NAME'].'</td>
<td align="center" valign="top" style="width:30%;">'.$detailRes[6]['TXD_AMT'].'</td>
</tr>
</table>
</div>
...
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[1]['SR']." ".$detailRes[1]['DED_NAME'].'</td>
<td align="left" valign="top" style="width:30%;">'.$detailRes[1]['TXD_AMT'].'</td>
</tr>
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[3]['SR']." ".$detailRes[3]['DED_NAME'].'</td>
<td align="left" valign="top" style="width:30%;">'.$detailRes[3]['TXD_AMT'].'</td>
</tr>
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[5]['SR']." ".$detailRes[5]['DED_NAME'].'</td>
<td align="left" valign="top" style="width:30%;">'.$detailRes[5]['TXD_AMT'].'</td>
</tr>
<tr>
<td align="left" valign="top" style="width:70%;">'. $detailRes[7]['SR']." ".$detailRes[7]['DED_NAME'].'</td>
<td align="left" valign="top" style="width:30%;">'.$detailRes[7]['TXD_AMT'].'</td>
</tr>
</table>
</div>
<div class="summary" style="width: 100%; top: 100mm; height:16mm;">
<table align="left" style="width:84%">
<tr>
<td style="width:55%"></td>
<td style="width:26%"></td>
<td align="center" valign="center" style="width:19%;">'.$printdataRes[0]['DEDUCTION'].'</td>
</tr>
<tr>
<td valign="bottom" height="8mm" align="left" style="width:55%;">&nbsp;&nbsp;&nbsp;&nbsp;'.$marathinumber->getIndianCurrency($printdataRes[0]['NETT_AMT']).' फक्त</td>
<td height="8mm" style="width:26%"></td>
<td  align="center" height="8mm" valign="bottom" style="width:19%;">'.$printdataRes[0]['NETT_AMT'].'</td>
</tr>
</table>
</div>
