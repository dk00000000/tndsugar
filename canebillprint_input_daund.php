<?  
     // session_start();
      ...
      if(isset($_POST['getFornight'])){
         ...
         $fornightres = $curd->GetSelData($oldFilter,$newFilter,'canebill_print_daund.ini','FORNIGHT');
     ...
     <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
           <form id="districtform" class="form-horizontal form-label-left" method="POST" action="canebill_print_daund.php" target="_blank" >
          
           <span class="section">Cane Bill Print </span>
 ...
 $(document).ready(function() {
    ...
    $('#season').change(function(){
        ...
        jQuery.ajax({ 
            ...
            datatype: "json",
            async: false,
            url: "canebillprint_input_daund.php",
