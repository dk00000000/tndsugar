     ...
     <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
           <form id="hnt_bankwise_form" class="form-horizontal form-label-left" method="POST" action="bankpayment_bank.php" target="_blank">
          ...
          <div class="panel-heading" id="addpanel">Input</div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Bank Name</span></label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select id ="bank" name="bank[]" class="form-control col-md-7 col-xs-12" multiple="multiple">
                <? for($i=0;$i<sizeof($bankres);$i++){?>
                  <option value="<?=$bankres[$i]['BK_CODE']."||".$bankres[$i]['BK_MNAME']?>"><?=$bankres[$i]['BK_CODE']." ".$bankres[$i]['BK_MNAME']?></option>
                <? } ?> 
                </select>
              </div>
            </div>  
 ...
 $(document).ready(function() {
  ...
  $('#season').change(function(){
      ...
      jQuery.ajax({ 
        ...
        datatype: "json",
        async: false,
        url: "bankpayment_bank_input.php",
