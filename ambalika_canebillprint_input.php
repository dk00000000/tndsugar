<?  
	...
	//Get Fortnight Lov
     ...
     /* if(isset($_POST['getFornight'])){
         ...
         $fornightres = $curd->GetSelData($oldFilter,$newFilter,'ambalika_canebill_print.ini','FORNIGHT');
     ...
     <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
           <form id="districtform" class="form-horizontal form-label-left" method="POST" action="ambalika_canebill_print.php" target="_blank" >
...
<? include("footer.php");?>
 ...
 $(document).ready(function() {
	...
	jQuery.ajax({
				...
				datatype: "json",
				async: false,
				url: "ambalika_canebillprint_input.php",
