     ...
     <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
           <form  class="form-horizontal form-label-left" id="bill_gen" action="ambalika_transbillpreprint.php" target="_blank" method="POST">
           <ul class="contactus-list">
           <span class="section">Transporter Bill Print Input 
                       </span>
        
          <div class="panel panel-primary">
          <div class="panel-heading" id="addpanel">Transporter Bill Print</div>
        <div class="panel-body">
          <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Season <span class="required">*</span></label>
              <li>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select id ="season" name="season" class="form-control col-md-7 col-xs-12" valid="required" errmsg="Please Select Season."  >
            ...
            <div class="form-group">
              ...
              <li>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select id ="contract_type" name="contract_type" class="form-control col-md-7 col-xs-12" valid="required" errmsg="Please Select Contract Type."  >
                  <option value="">Select</option>
                     <option value="CT001">Transporter</option>
                     <option value="CT002">Harvestor</option> 
                  </select>
                </div>
              </li>
            </div>  
 ...
 $(document).ready(function() {
    ...
    $('#contract_type').change(function(){
        ...
        jQuery.ajax({ 
            ...
            datatype: "json",
            async: false,
            url: "ambalika_transbillpreprint_input.php",
