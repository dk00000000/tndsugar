     ...
     <div class="clearfix"></div>
      ...
      <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
           <form  class="form-horizontal form-label-left" id="bill_gen" action="ambalika_bulllockcartpreprint.php" target="_blank" method="POST">
 ...
 $(document).ready(function() {
      $('#season').change(function(){
        ...
        jQuery.ajax({ 
            ...
            datatype: "json",
            async: false,
            url: "ambalika_bulllockcartpreprint_input.php",
