...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
    ...
    <style>    
      *{padding:0; margin:0;}
         html, body {font-family: 'verdana', sans-serif;font-size: 13px;}
...
<td style="width: 40px; " colspan="3" valign="top" align="center">&nbsp;<?php echo $printdataRes[0]['MILL_NUMBER']; ?></td>
</tr> 
...
<td style="width: 40px; " valign="bottom" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $printdataRes[0]['FRMR_NAME']; ?></td>
...
<td style="width: 56px; " valign="bottom" colspan="2" align="right">&nbsp;<?php echo $printdataRes[0]['DSL_VILLAGE_NAME']; ?></td>
